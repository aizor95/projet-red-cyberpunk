...
func characterTurn(
	...
	for {
		...
		case 1:
			...
			fmt.Println(
				"Attaque utilisée : Attaque basique",
			)
...
func combatSkills(
	...
	default:
		...
		fmt.Println(
			"Cette compétence n'est pas utilisable.",
		)
...
func monsterDefeated(
	...
	// Le système de quête vérifie automatiquement
	// si ce monstre correspond à la quête active.
	updateQuestProgress(
		p,
		"kill",
		monster.Name,
